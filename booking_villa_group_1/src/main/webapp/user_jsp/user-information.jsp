    ...
    <div class="main-body">
        <div id="header" class="boxshadow-outset">
            ...
            <div class="link-items">
                <a class="backgroundcolor-2 hover" href="main-page.jsp">Trang chủ</a>
                <a class="backgroundcolor-2 hover">Booking</a>
                <a href="/login?action=showInformationUser">Xem</a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 btn-action">
                                <a class="btn btn-info content " href="/user_jsp/form-update-user.jsp">Sửa</a>
                                <a class="btn btn-info content" href="/user_jsp/change-password.jsp">Đổi mật khẩu</a>
                                <button type="button" class="btn btn-danger content" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" style="padding: 10px">
                                    Xóa
                                </button>
                            </div>
                        </div>
