...
<head>
    ...
    <link rel="stylesheet" href="css_index/userInformation.css">
</head>
<body>
<div class="container">
    <div class="main-body">
            ...
            <div class="col-md-8">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a class="btn btn-info " href="/form-update-user.jsp">Sửa</a>
                                <a class="btn btn-info " href="/change-password.jsp">Đổi mật khẩu</a>
